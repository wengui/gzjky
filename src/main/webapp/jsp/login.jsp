      ...
      <div class="bg_top_login">
        <div class="login_out">
          <ul>
           ...
           <li class="login_register"><a href="<c:url value='/jsp/register/protocol.jsp'/>" title="注册">立即注册</a></li> 
          </ul>
        </div>
      </div>
      <div class="logo_menu">
        <div class="bg_logo">
          <div class="login_menu">
            <ul>
              <li></li>
              <li class="activation"><a href="login.html" title="首页">首页</a></li>
              <li><a href="<c:url value='/jsp/download/download.jsp'/>" title="APP下载、Android、iOS" target="_blank">应用下载</a></li>
              <!-- <li><a href="/jsp/newbie/newbie.jsp" title="新手上路" target="_blank">新手上路</a></li> -->
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="bg_login_mian">
          <div class="login_main">
            ...
            <ul>
              ...
              <li class="login_input"><input type="text" id="login_id" name="loginId" class="lInput" value="用户名/手机/邮箱" onclick="checkLoginInput('onclick')" onblur="checkLoginInput('onblur')"/></li>
              <li class="tBlack">密码</li>
              <li class="login_input"><input type="password" id="passwd" name="passwd" class="lInput" /></li>
              ...
              <li class="login_btn"><a href="javascript:void(0)" onclick="login();" title="登录">登录</a></li>
