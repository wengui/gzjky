   ...
   <!--register_header start--> 
	<div class="register_header">
      <div class="bgTop_register">
        <div class="login_out">
          <ul>
           <li class="login_wechat"><a href="/jsp/health/index/wechat.jsp" title="995120健康服务中心官方微信" target="_blank">官方微信</a></li>
           ...
           <li class="login_top"><a href="/login.html">用户登录</a></li>
           <li class="login_register"><a href="/jsp/register/protocol.jsp">立即注册</a></li> 
          </ul>
        </div>
        <div class="logo_menu">
