      ...
      <div class="bgTop_register">
        <div class="login_out">
          <ul>
           ...
           <li class="login_register"><a href="/jsp/register/register.jsp" title="注册">立即注册</a></li> 
          </ul>
        </div>
        <div class="logo_menu">
          <div class="bgLogo_register">
            <ul>
             ...
             <li class="goHome"><a href="/login.html" title="返回首页">返回首页</a></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="bg_register">
          <div class="register_success">
            <ul>
              ...
              <li><a href="/login.html" title="立即登录">立即登录</a><span class="line_success">|</span><a href="/login.html" title="返回首页">返回首页</a></li>
            </ul>
          </div>  
        </div>
      </div>  
