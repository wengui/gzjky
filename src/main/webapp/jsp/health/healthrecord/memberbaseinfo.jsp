					        ...
					        <div class="col-lg-10 col-xs-10">
					        	<div class="form-group">
							        ...
							        <div class="col-lg-12 col-xs-12">
							        	...
							        	<select  class="col-lg-8 col-xs-8 display-input selectMax_informationModify  validate[required]"  id="dictSex"  name="dictSex"></select>
							        </div>
							        <div class="col-lg-12 col-xs-12">	
							        	<span class="col-lg-4 col-xs-4 text-right  form-span">*出生日期：</span>
							        	<input class="col-lg-8 col-xs-8 display-input validate[required]"  type="text"   id="patientbirthday"  name="patientbirthday"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d',errDealMode:2})" />
							        </div>
							        <div class="col-lg-12 col-xs-12">	
							        	<lable class="col-lg-4 col-xs-4 text-right form-span">*手机号：</lable>
							        	<input class="col-lg-8 col-xs-8 display-input validate[required,funcCall[mobilephone]]"  type="text"  id="patientphone"  name="patientphone"   />
							        </div>
							        <div class="col-lg-12 col-xs-12">	
							        	<span class="col-lg-4 col-xs-4 text-right  form-span">*电子邮箱：</span>
							        	<input class="col-lg-8 col-xs-8 display-input validate[required,custom[email]]" type="text"  id="email"   name="email"   />
									</div>
							        </div>
					         ...
					         <div class="col-lg-10 col-xs-10">
					         	<div class="col-lg-12 col-xs-12">
							        <div class="col-lg-6 col-xs-6">
							        	...
							        	<select class="display-input selectMax_informationModify col-lg-8 col-xs-8"  id="certiType"  name="certiType"  onchange="change_credentials_type(this)">
						                </select>
							        </div>
							        <div class="col-lg-6 col-xs-6">
							        	<lable class="col-lg-4 col-xs-4 text-right form-span">证件号码：</lable>
							        	<input class="col-lg-8 col-xs-8 display-input validate[funcCall[includespecialchar]]"  type="text"  maxlength="18" id="cardnum" name="cardnum"  />
							        </div>
								</div>
								<div class="col-lg-12 col-xs-12">
							        <div class="col-lg-6 col-xs-6">
							        	<span class="col-lg-4 col-xs-4 text-right  form-span">是否军人：</span>
							        	<select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="issoldier"  name="issoldier">
					                	<option value="1">是</option>
						                <option value="0">否</option>
						                </select>
							        </div>
							        <div class="col-lg-6 col-xs-6">
							        	<lable class="col-lg-4 col-xs-4 text-right form-span">是否残疾：</lable>
							        	<select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="isdisability"  name="isdisability" >
						                <option value="0">否</option>
						                <option value="1">是</option>
						                </select>
							        </div>
						        ...
						        <div class="col-lg-12 col-xs-12">
							        <div class="col-lg-6 col-xs-6">
							        	<span class="col-lg-4 col-xs-4 text-right form-span">身高(cm)：</span>
							        	<input class="col-lg-8 col-xs-4 display-input inputMin_informationModify validate[funcCall[pyheight]]"  type="text"  id="height"   name="height"  maxlength="3" />
							        </div>
							        <div class="col-lg-6 col-xs-6">
							        	<lable class="col-lg-4 col-xs-4 text-right form-span">体重(kg)：</lable>
							        	<input class="col-lg-8 col-xs-8 display-input inputMin_informationModify validate[funcCall[pyweight]]" type="text"  id="weight" name="weight"  maxlength="3" />
							        </div>
						        </div>
						        <div class="col-lg-12 col-xs-12">
							        <div class="col-lg-6 col-xs-6">
							        	<span class="col-lg-4 col-xs-4 text-right  form-span">民族：</span>
										<select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="nationalityCodeDict"  name="nationalityCodeDict" >
										</select>
							        </div>
							        <div class="col-lg-6 col-xs-6">
							        	<lable class="col-lg-4 col-xs-4 text-right form-span">籍贯：</lable>
							        	<input class="col-lg-8 col-xs-8 display-input inputMin_informationModify validate[funcCall[chinese]]" type="text" id="nativeplace"  name="nativeplace" maxlength="64" />
							        </div>
						        </div>
						        <div class="col-lg-12 col-xs-12">
							        <div class="col-lg-6 col-xs-6">
							        	<span class="col-lg-4 col-xs-4 text-right  form-span">婚姻状况：</span>
							        	<select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="maritalStatusDict"  name="maritalStatusDict" >
						                </select>
							        </div>
							        <div class="col-lg-6 col-xs-6">
							        	<lable class="col-lg-4 col-xs-4 text-right form-span">户籍类型：</lable>
							        	<select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="censusRegDict"  name="censusRegDict" >
						                </select>
							        </div>
						        </div>
						        <div class="col-lg-12 col-xs-12">
							        <div class="col-lg-6 col-xs-6">
							        	<span class="col-lg-4 col-xs-4 text-right  form-span">学历：</span>
							        	<select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="userAcademic" name="userAcademic"  >
						                </select>
							        </div>
							        <div class="col-lg-6 col-xs-6">
							        	<lable class="col-lg-4 col-xs-4 text-right form-span">政治面貌：</lable>
							        	<select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="politicalAffiliatio"  name="politicalAffiliatio">
						                </select>
							        </div>
						        </div>
						        <div class="col-lg-12 col-xs-12">
							        <div class="col-lg-6 col-xs-6">
							        	<span class="col-lg-4 col-xs-4 text-right form-span">家庭电话：</span>
							        	<input class="col-lg-8 col-xs-8 display-input inputMin_informationModify text-input validate[funcCall[telephone]]" type="text" id="telephone"  name="telephone"  />
							        </div>
			      ...
			      <!--job_information start-->
			        <div class="row informationModify_main" >
			          <div class="col-lg-10 col-xs-10">
			        	<div class="col-lg-12 col-xs-12">
					        <div class="col-lg-6 col-xs-6">
					        	<span class="col-lg-4 col-xs-4 text-right form-span">工作年限：</span>
					        	 <select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="workingyear" name="workingyear">
				                </select>
					        </div>
					        <div class="col-lg-6 col-xs-6">
					        	<lable class="col-lg-4 col-xs-4 text-right form-span">薪酬：</lable>
					        	<select class="col-lg-8 col-xs-8 display-input selectMax_informationModify" id="moneyForYear"  name="moneyForYear">
				                </select>
					        </div>
				        </div>
				        ...
				        <div class="col-lg-12 col-xs-12">
					        <div class="col-lg-6 col-xs-6">
					        	<span class="col-lg-4 col-xs-4 text-right  form-span">公司名称：</span>
					        	<input class="col-lg-8 col-xs-8 display-input inputMax_informationModify validate[funcCall[includespecialchar]]" type="text"  id="companyname"  name="companyname"  maxlength="64" />
					        </div>
					        <div class="col-lg-6 col-xs-6">&nbsp;</div>
				        </div>
				        <div class="col-lg-12 col-xs-12">
