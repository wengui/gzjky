	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				 ...
				 * Ajax PHP 验证示例
				 * 	"ajaxUserCallPhp": {
				 * 		"url": "http://www.995120.cn/js/validationEngine/languages/phpajax/ajaxValidateFieldUser.php",
				 ...
				 * 		"url": "http://www.995120.cn/js/validationEngine/languages/phpajax/ajaxValidateFieldName.php",
				 * 		// error
				 * 		"alertText": "* 此名称已被其他人使用",
				 * 		// speaks by itself
