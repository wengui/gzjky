 ...
 *
 */
public class QueryMemberConsultationAction extends ActionSupport {
	...
	@Autowired
	private MemberConsultationReadMapper memberConsultationReadMapper;
	
	
	public String getMemberConsultationRrecord(){
		...
		try {
			...
			QueryMemberConsultationOutPutBean result = memberConsultationReadMapper.selectByPatientID(patientID);
